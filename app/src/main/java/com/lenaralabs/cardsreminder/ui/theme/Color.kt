...
val SheetItemSurfaceLight = Color(0xFFF2F1F6)
val SheetItemSurfaceDark = Color(0xFF2A2A2E)

val SecondaryTextLight = Color(0xFF64748B)
val SecondaryTextDark = Color(0xFF94A3B8)

val DefaultBorderLight = Color(0xFFE2E8F0)
val DefaultBorderDark = Color(0xFF2D3452)

val HeaderSurfaceLight = Color(0xFF1A1F36)
val HeaderSurfaceDark = Color(0xFF0D1021)

val CalendarTagSurfaceLight = Color(0xFFF2F1F6)
val CalendarTagSurfaceDark = Color(0xFF1C1C1E)

val OptimalDayLight = Color(0xFF6EE7B7)
val OptimalDayDark = Color(0xFF34D399)

// Amber state
val AmberStateForegroundLight = Color(0xFFB08A4A)
val AmberStateForegroundDark = Color(0xFFC9B896)

val AmberStateBackgroundLight = Color(0xFFFFF8EC)
val AmberStateBackgroundDark = Color(0xFF252019)

// Emerald state
val EmeraldStateForegroundLight = Color(0xFF5E9A7E)
val EmeraldStateForegroundDark = Color(0xFF8FBDAA)

val EmeraldStateBackgroundLight = Color(0xFFEDFAF3)
val EmeraldStateBackgroundDark = Color(0xFF1A2420)

// Red state
val RedStateForegroundLight = Color(0xFFC17B7B)
val RedStateForegroundDark = Color(0xFFC99999)
...
val OnTrackStateForegroundDark = Color(0xFFAEAEB2)
